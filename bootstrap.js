...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "mobile.controller.OfflineController": [],
  "mobile.controller.SelfController": [],
  "mobile.controller.SharedController": [],
  "mobile.controller.TaskController": [],
  "mobile.controller.UserController": [],
  "mobile.model.Offline": [],
  "mobile.model.OfflineDetail": [],
  "mobile.model.SelfMenu": [],
  "mobile.model.Shared": [],
  "mobile.model.Task": [],
  "mobile.model.User": [],
  "mobile.model.WithdrawalHistory": [],
  "mobile.override.picker.Picker": [],
  "mobile.override.plugin.PullRefresh": [],
  "mobile.store.CityStore": [],
  "mobile.store.OfflineStore": [],
  "mobile.store.ProvinceStore": [],
  "mobile.store.SelfMenuStore": [],
  "mobile.store.SharedStore": [],
  "mobile.store.TaskStore": [],
  "mobile.store.UserStore": [],
  "mobile.store.WithdrawalHistoryStore": [],
  "mobile.view.ForgetFrom": [],
  "mobile.view.LoginForm": [],
  "mobile.view.Main": [],
  "mobile.view.MainPanel": [],
  "mobile.view.MyUtils": [],
  "mobile.view.RegisterForm": [],
  "mobile.view.offline.OfflineDetailPanel": [],
  "mobile.view.self.MyInfo": [],
  "mobile.view.self.MyPassword": [],
  "mobile.view.self.Withdrawal": [],
  "mobile.view.self.WithdrawalHistory": [],
  "mobile.view.shared.SharedUploadPanel": [],
  "mobile.view.task.TaskDetailPanel": []
});
Ext.ClassManager.addNameAliasMappings({
  ...
  "mobile.view.shared.SharedUploadPanel": [
    "widget.sharedUploadPanel"
  ],
  "mobile.view.task.TaskDetailPanel": [
    "widget.taskDetailPanel"
  ]
});
